...
window.addEventListener("load", function(): void {
 ...
 //Loop//  
    document.getElementById("play-button").addEventListener("click", function() {
        var loopstation: number = setInterval(function() {
...
//remix//
    document.getElementById("remix").addEventListener("click", function() {setInterval(function() {
        playSample( beat [laufvar]);
        random = Math.random ();  
